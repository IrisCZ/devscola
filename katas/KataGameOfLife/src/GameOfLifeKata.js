...
given any starting position. See http://en.wikipedia.org/wiki/Conway%27s_
Game_of_Life for background.
...
var gameOfLifeKata = {
  ...
  underpopulation: function(neightbourgsAlive) {
    return (neightbourgsAlive < 2);
  },

  overcrowding: function(neightbourgsAlive) {
    return (neightbourgsAlive > 3);
  },

  aliveForNextGeneration: function(neightbourgsAlive) {
    return (neightbourgsAlive === 2 || this.alive(neightbourgsAlive));
  },

  alive: function(neightbourgsAlive) {
    return (neightbourgsAlive === 3);
  }
}
